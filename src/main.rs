...
fn main() {
    // test beziers
    let cubic = Bezier::new_c(Point { x: 0.0, y: 0.0 }, Point { x: 1.0, y: 1.0 }, Point { x: 2.0, y: 1.0 }, Point { x: 3.0, y: 0.0 }, Point { x: 4.0, y: 0.0 });
    let quadratic = Bezier::new_q(Point { x: 0.0, y: 0.0 }, Point { x: 1.0, y: 1.0 }, Point { x: 2.0, y: 0.0 }, Point { x: 3.0, y: 0.0 });
    let line = Bezier::new_l(Point { x: 0.0, y: 0.0 }, Point { x: 1.0, y: 1.0 }, Point { x: 2.0, y: 0.0 });
